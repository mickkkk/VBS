...
// };
export default class Schedule3 extends React.Component {
  state = {
    fontLoaded: false,
  };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Maandag 24 September</Text>
                </View>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Dinsdag 25 September</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Woensdag 26 September</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Donderdag 27 September</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Vrijdag 28 September</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
