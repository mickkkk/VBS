...
// };
export default class Schedule7 extends React.Component {
  state = {
    fontLoaded: false,
  };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Maandag 22 Oktober</Text>
                </View>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Dinsdag 23 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Woensdag 24 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Donderdag 25 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Vrijdag 26 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
