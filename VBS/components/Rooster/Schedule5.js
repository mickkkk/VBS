...
// };
export default class Schedule5 extends React.Component {
  state = {
    fontLoaded: false,
  };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Maandag 8 Oktober</Text>
                </View>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Dinsdag 9 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Woensdag 10 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Donderdag 11 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Vrijdag 12 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
