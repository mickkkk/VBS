...
// };
export default class Schedule8 extends React.Component {
  state = {
    fontLoaded: false,
  };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Maandag 29 Oktober</Text>
                </View>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Dinsdag 30 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Woensdag 31 Oktober</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Donderdag 1 November</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
            ...
            <View style={styles.day}>
                <View style={styles.header}>
                    <Text style={styles.headerText}>Vrijdag 2 November</Text>
                </View>
                <View style={styles.line} />
                <View style={styles.item}>
                    <Text style={styles.time}>09:00-11:00</Text>
